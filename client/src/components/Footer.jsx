            ...
            <footer className="footer mt-5 mb-3">
                ...
                <div>
                    ...
                    <ul className="links">
                        ...
                        <li><a href="#"><i className="fa fa-chevron-right" aria-hidden="true"></i> &nbsp; &nbsp;&nbsp;Feedback</a></li>
                ...
                <div>
                    ...
                    <ul className="contact">
                        <li><i className="fa fa-envelope" aria-hidden="true"></i> blogbliss@gmail.com</li>
                        <li><i className="fa fa-envelope" aria-hidden="true"></i> chinmaytadela@gmail.com</li>
                        <li><i className="fa fa-envelope" aria-hidden="true"></i> rohanaerra@gmail.com</li>
                        <li><i className="fa fa-envelope" aria-hidden="true"></i> ravikirankachiraju@gmail.com</li>
                ...
                <div>
                    ...
                    <ul className="social">
                        <li><a href="#">X</a><i className='social-icon' style={{fontSize : '18px'}}></i></li>
                        ...
                        <li><a href="#">Github <i className="bi bi-github"></i></a></li>
                    </ul>
                </div>
